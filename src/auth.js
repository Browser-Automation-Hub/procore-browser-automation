/**
 * auth.js — Authentication handler for Procore
 * Supports: SSO (Okta / Google / Microsoft SAML), MFA (Okta / Google Authenticator / SMS)
 *
...
const BASE_URL = process.env.PROCORE_URL || 'https://login.procore.com/';
const USERNAME = process.env.PROCORE_USERNAME;
...
async function performLogin(page) {
  if (!USERNAME || !PASSWORD) {
    throw new Error(`Set PROCORE_USERNAME and PROCORE_PASSWORD in .env`);
  }
